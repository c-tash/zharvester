            ...
            try {
                ...
                if (query.getActive().equals("save")) {
                    if(SQLiteJDBC.dbCheck(hash, resultsDir))
                    {
                        ...
                        if (resultSet != null && resultSet.getHitCount() > 0 && resultSet.getRecord(0) != null &&
                                resultSet.getRecord(0).getSyntax() != null && (resultSet.getRecord(0).getSyntax().equalsIgnoreCase("usmarc")
